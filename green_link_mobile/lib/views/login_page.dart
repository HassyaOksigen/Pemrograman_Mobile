...
import 'vendor/vendor_dashboard.dart'; // Import halaman vendor
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (res['success']) {
                            // Logika Pemisah Role (Vendor vs Customer)
                            String role = auth.user!.namaPeran;
                            
                            if (role.toLowerCase() == 'vendor') {
                              Navigator.pushReplacement(
                                context, 
                                MaterialPageRoute(builder: (_) => VendorDashboard(vendorId: auth.user!.id))
                              );
                            } else {
                              Navigator.pushReplacement(
                                context, 
